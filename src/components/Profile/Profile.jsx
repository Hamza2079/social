  ...
  return (
    <div className="min-h-[calc(100vh-80px)]">
      ...
      <div className="max-w-4xl mx-auto px-4 -mt-20 relative">
        ...
        <div className="mt-4">
          <h1 className="text-2xl md:text-3xl font-bold text-base-content">{userData?.name}</h1>
          ...
          <div className="flex gap-6 mt-4 text-xs font-medium opacity-70">
            <p><span className="font-bold text-base-content">{data?.posts.length}</span> Posts</p>
          </div>
        </div>
        ...
        <div className="mt-6 space-y-6 pb-10">
          ...
          {data?.posts.slice().reverse().map((post, index) => (
            <div
            key={post._id}
