...
export default function Profile() {
  const { userData, setToken, refreshUser } = useContext(tokencontext);
  ...
  const ProfileHeaderSkeleton = () => (
    <div className="flex items-center gap-8 sm:gap-16 mb-10">
      <div className="w-24 h-24 sm:w-36 sm:h-36 rounded-full bg-base-300 animate-pulse shrink-0"></div>
      <div className="flex-1">
        ...
        <div className="h-4 w-24 bg-base-300 animate-pulse rounded-md"></div>
      </div>
    </div>
  );
      ...
      <div className="max-w-[935px] mx-auto px-4 sm:px-8 py-8">
        ...
        <div className="flex justify-center gap-12 text-xs font-semibold tracking-wider uppercase text-base-content/40 -mt-px">
          <button
            ...
            className={`flex items-center gap-1.5 py-3 border-t-2 transition-colors ${
              activeTab === "posts"
                ? "border-base-content text-base-content"
                : "border-transparent hover:text-base-content/60"
            }`}
          >
            <BsGrid3X3 className="w-3 h-3" /> Posts
          </button>
          <button
          ...
          >
            <HiOutlineBookmark className="w-3.5 h-3.5" /> Saved
          </button>
        </div>
          ...
          <div className="max-w-[470px] mx-auto space-y-0 mt-4">
            {bookmarksLoading ? (
              ...
              <div className="text-center py-16">
                <HiOutlineBookmark className="w-10 h-10 mx-auto mb-3 text-base-content/20" />
...
function ProfileFollowModalRow({
  user,
  currentUserId,
  userData,
  onNavigate,
