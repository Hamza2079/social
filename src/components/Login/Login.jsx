...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center" data-theme="dark">
      <div className="w-full max-w-md mx-auto px-6 py-8 rounded-3xl bg-base-200
